<nav aria-label="...">
  <ul class="pagination">
    ...
    <c:if test="${pagination.paginaActual > 1}">
      <li class="page-item">
        <a class="page-link" href="${pagination.url}?desde=0&filas=${pagination.filas}" title="Ir a la primera página">
    ...
    <c:forEach var="i" begin="${pagination.inicio}" end="${pagination.fin}">
      <li class="page-item ${i == pagination.paginaActual ? 'active' : ''}">
        ...
        <a class="page-link" href="${pagination.url}?desde=${(i - 1) * pagination.filas}&filas=${pagination.filas}">
          ${i}
        </a>
      </li>
    </c:forEach>
