...
<body>
    <head>
        ...
        <script src="/usuarios/usuariosList.js"></script>
                ...
                <tbody>            
                    <c:forEach items="${data}" var="usuario">
                        <tr>
                            ...
                            <td class="col-action">
                                <c:url var="urlEditar" value="/users/ver/${usuario.id}">
                                </c:url>
                                ...
                                <a href="${urlEditar}">
                                    ...
                                    <!--  -->
                                        <button class="btn btn-delete" onclick="eliminarClick(<c:out value='${usuario.id}'/>)">
                                            <svg style="width: 1.5em;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
