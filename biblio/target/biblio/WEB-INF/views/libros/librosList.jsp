...
<body>
    <head>
        ...
        <link href="/static/styles/books/librosList.css" rel="stylesheet">
    ...
    <body>
        ...
        <div class="container">
            ...
            <table class="table table-striped">
                ...
                <tbody>            
                    <c:forEach items="${data}" var="libro">
                        <tr>
                            ...
                            <td><c:out value="${libro.idioma}"/></td>
                            <td class="col-action">
                                <c:url var="urlEditar" value="/books/ver/${libro.id}">
                                </c:url>
